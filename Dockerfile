...
RUN pip install click cython galois icecream ipython pyapproxmc pycryptosat!=5.11.23 sat_toolkit>=0.4.6 galois setuptools tqdm numpy scipy python-sat[aiger,approxmc,cryptosat,pblib]
